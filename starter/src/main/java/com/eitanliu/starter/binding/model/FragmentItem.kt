...
class FragmentItem private constructor(
    ...
    val args: Bundle?,
    val tag: String? = null,
    @IdRes val id: Int = ResourcesCompat.ID_NULL,
    ...
    companion object {
        ...
        inline fun <reified T : Fragment> create(
            args: Bundle?, tag: String? = null, id: Int = ResourcesCompat.ID_NULL,
            crossinline create: (FragmentItem) -> T
        ...
        inline fun <reified T : Fragment> create(
            args: Bundle? = null, tag: String? = null, id: Int = ResourcesCompat.ID_NULL,
        ) = create(T::class.java, args, tag, id)

        fun create(
            clazz: Class<out Fragment>, args: Bundle? = null,
            tag: String? = null, id: Int = ResourcesCompat.ID_NULL,
